          ...
          <Col className="ml-auto mr-auto" md="8">
            <div className="section-description text-center">
              ...
              <h5 className="description">
                Build pages in no time using pre-made sections! We have created multiple sections for you to put together and customise into pixel
                perfect example pages. From headers to footers, you will be able to choose the best combination for your project.
              </h5>
              <br />
        ...
        <Container fluid>
          <div className="section-cols">
            <Container fluid>
              ...
              <Row>
                <Col md="3">
                  <img alt="..." src={require('assets/img/presentation-page/screenshots/team-cards-social.jpg').default} />
                </Col>
                <Col md="3">
                  <img alt="..." src={require('assets/img/presentation-page/screenshots/bg-pricing-card.jpg').default} />
                </Col>
                <Col md="3">
                  <img alt="..." src={require('assets/img/presentation-page/screenshots/white-pricing-card.jpg').default} />
                </Col>
                <Col md="3">
                  <img alt="..." src={require('assets/img/presentation-page/screenshots/team-member-card.jpg').default} />
                </Col>
              </Row>
              <Row>
                <Col md="3">
              ...
              <Row>
                ...
                <Col md="3">
                  <img alt="..." src={require('assets/img/presentation-page/screenshots/blogpost-2-cards.jpg').default} />
                </Col>
                <Col md="3">
                  <img alt="..." src={require('assets/img/presentation-page/screenshots/coloured-picind-card.jpg').default} />
                </Col>
                <Col md="3">
