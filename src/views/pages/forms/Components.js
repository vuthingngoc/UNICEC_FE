...
function Components() {
  ...
  const [slider2Values, setSlider2Values] = React.useState(['200.00', '400.00']);
  ...
  const handleReactDatetimeChange = (who, date) => {
    if (startDate && who === 'endDate' && new Date(startDate._d + '') > new Date(date._d + '')) {
      setStartDate(date);
      setEndDate(date);
    } else if (endDate && who === 'startDate' && new Date(endDate._d + '') < new Date(date._d + '')) {
      setStartDate(date);
      setEndDate(date);
    } else {
      if (who === 'startDate') {
                      ...
                      <Col md="6">
                        <FormGroup>
                          ...
                          >
                            ...
                            <Input placeholder="Your name" type="text" onFocus={() => setyourName(true)} onBlur={() => setyourName(false)} />
                          </InputGroup>
                        </FormGroup>
                      </Col>
                      <Col md="6">
                    ...
                    <Row>
                      <Col md="6">
                        <FormGroup>
                          ...
                          >
                            <Input placeholder="Location" type="text" onFocus={() => setlocation(true)} onBlur={() => setlocation(false)} />
                      ...
                      <Col md="6">
                        <FormGroup>
                          ...
                          >
                            <Input placeholder="Password" type="password" onFocus={() => setpassword(true)} onBlur={() => setpassword(false)} />
                            <InputGroupAddon addonType="append">
                              <InputGroupText>
                        ...
                        <FormGroup>
                          ...
                          >
                            ...
                            <Input
                              ...
                              type="text"
                              onFocus={() => setpaymentMethos(true)}
                              onBlur={() => setpaymentMethos(false)}
                            />
                            <InputGroupAddon addonType="append">
                              <InputGroupText>
                      ...
                      <Col md="6">
                        <FormGroup>
                          ...
                          >
                            ...
                            <Input placeholder="Phone number" type="text" onFocus={() => setphoneNumber(true)} onBlur={() => setphoneNumber(false)} />
                            <InputGroupAddon addonType="append">
                              <InputGroupText>
                ...
                <CardBody>
                  <Form>
                    ...
                    <div className="mt-5">
                      ...
                      <Row>
                        <Col xs="6">
                          <span className="range-slider-value value-low">{slider2Values[0]}</span>
                        </Col>
                        <Col className="text-right" xs="6">
                          <span className="range-slider-value value-high">{slider2Values[1]}</span>
                        </Col>
                      </Row>
                    </div>
                  </Form>
