            ...
            <Card>
              ...
              <CardBody>
                ...
                <CardText className="mb-4">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis non dolore est fuga nobis ipsum illum eligendi nemo iure repellat,
              ...
              <CardBody>
                <Row className="align-items-center">
                  <Col className="col-auto">
                    <a className="avatar avatar-xl rounded-circle" href="#pablo" onClick={(e) => e.preventDefault()}>
              ...
              <CardBody>
                ...
                <div className="pt-4 text-center">
                  <h5 className="h3 title">
                    ...
                    <small className="h4 font-weight-light text-muted">Web Developer</small>
                  </h5>
                  <div className="mt-3">
                    <Button className="btn-icon-only rounded-circle" color="twitter" href="#pablo" onClick={(e) => e.preventDefault()}>
                      <i className="fab fa-twitter" />
                    </Button>
                    <Button className="btn-icon-only rounded-circle" color="facebook" href="#pablo" onClick={(e) => e.preventDefault()}>
                      <i className="fab fa-facebook" />
                    </Button>
                    <Button className="btn-icon-only rounded-circle" color="dribbble" href="#pablo" onClick={(e) => e.preventDefault()}>
          ...
          <Col lg="4">
            <Card className="card-pricing bg-gradient-success border-0 text-center mb-4">
              <CardHeader className="bg-transparent">
                <h4 className="text-uppercase ls-1 text-white py-3 mb-0">Bravo pack</h4>
              </CardHeader>
                ...
                <ul className="list-unstyled my-4">
                  <li>
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <span className="pl-2 text-sm text-white">Complete documentation</span>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <span className="pl-2 text-sm text-white">Working materials in Sketch</span>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <span className="pl-2 text-sm text-white">2GB cloud storage</span>
                      </div>
                    </div>
                  </li>
                </ul>
            ...
            <Card className="bg-dark text-white border-0">
              <CardImg alt="..." src={require('assets/img/theme/img-1-1000x600.jpg').default} />
              <CardImgOverlay className="d-flex align-items-center">
                <div>
                  ...
                  <CardText className="text-sm font-weight-bold">Last updated 3 mins ago</CardText>
                </div>
              </CardImgOverlay>
            </Card>
            ...
            <Card className="card-pricing border-0 text-center mb-4">
              <CardHeader className="bg-transparent">
                <h4 className="text-uppercase ls-1 text-primary py-3 mb-0">Bravo pack</h4>
              </CardHeader>
              <CardBody className="px-lg-7">
                ...
                <ul className="list-unstyled my-4">
                  <li>
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <span className="pl-2 text-sm">Complete documentation</span>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <span className="pl-2 text-sm">Working materials in Sketch</span>
                      </div>
                    </div>
                  </li>
                  <li>
