          ...
          <Row className="justify-content-center text-center">
            <Col md="6">
              ...
              <p className="lead text-white">
                ...
                động trong câu lạc bộ. Không chỉ thế đây còn là một sân chơi dành cho các bạn muốn tham gia những cuộc thi được tổ chức và tài trợ bởi
                các trường đại học hoặc các nhà tài trợ đến từ nhiều doanh nghiệp khác nhau.
              </p>
            </Col>
          </Row>
        </Container>
                  ...
                  <Col className="my-2" md="2" xs="3">
                    <a href="https://www.facebook.com/fcodefpt/" id="tooltip170669606">
                      <img
                        ...
                        src="https://scontent.fsgn5-9.fna.fbcdn.net/v/t39.30808-6/241277567_2935941399955753_2523832604141178857_n.png?_nc_cat=105&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=_ES-4u9GN_EAX_FpP7G&_nc_ht=scontent.fsgn5-9.fna&oh=00_AT_vj-BkhhxSLK9t_ctMu90Wdq2tfaBy7VTtZqveuoSiiw&oe=626CFD79"
                      />
                    </a>
                  ...
                  <Col className="my-2" md="2" xs="3">
                    <a href="https://www.facebook.com/fptgoclub/" id="tooltip374813716">
                      <img
                        alt="..."
                        className="img-fluid rounded-circle"
                        src="https://scontent.fsgn5-8.fna.fbcdn.net/v/t1.6435-9/146602286_2531433107150204_5635383335858587773_n.png?_nc_cat=109&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=DdCuJ1o7LWAAX9LADq7&_nc_ht=scontent.fsgn5-8.fna&oh=00_AT-Jk2__XNCieHuOGjrOcsLYKdzpEuCeNs7P_-sz3wFWrQ&oe=628D4D47"
                      />
                    </a>
                  ...
                  <Col className="my-2" md="2" xs="3">
                    <a href="https://www.facebook.com/iGoClub" id="tooltip82987604">
                      <img
                        alt="..."
                        className="img-fluid rounded-circle"
                        src="https://scontent.fsgn5-14.fna.fbcdn.net/v/t39.30808-6/278402228_407676238026069_7257878776928739635_n.jpg?_nc_cat=106&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=rNFO1OaF_PsAX-IIzr-&_nc_ht=scontent.fsgn5-14.fna&oh=00_AT9V7DlDOIsoSvtv3n4ao2Olju_eNE5ru6xO5I3ZmZfgzQ&oe=626CA3AB"
                      />
                    </a>
